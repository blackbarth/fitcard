...
{
    public class EmpresaTesteController : IClassFixture<TestFixture<Startup>>
    {
        private HttpClient Client;
        private string _token;
        private string _controller = "empresa";
        ...
        public EmpresaTesteController(TestFixture<Startup> fixture)
        {
