...
{
    public class CategoriaTesteController : IClassFixture<TestFixture<Startup>>
    {
        private HttpClient Client;
        private string _token;
        private string _controller = "categoria";
        ...
        public CategoriaTesteController(TestFixture<Startup> fixture)
        {
